...
export function featureReducer(
  ...
  switch (action.type) {
    ...
    case ActionTypes.COMPLETE_TICKET: {
        return featureAdapter.updateOne({ id: action.payload.ticketId, changes: { completed: true } }, {
        ...state,
        isLoading: false,
        error: null
      });
    ...
    case ActionTypes.COMPLETE_TICKET_FAILURE: {
      console.log('reducer',{ id: action.payload.ticketId, changes: { completed: action.payload.originalStatus}});
      return featureAdapter.updateOne({ id: action.payload.ticketId, changes: { completed: action.payload.originalStatus} }, {
        ...state,
        isLoading: false
      });
    }
